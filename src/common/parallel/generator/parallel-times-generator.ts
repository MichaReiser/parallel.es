...
export class ParallelTimesGenerator implements IParallelGenerator {
  public static create<TResult>(
    n: number,
    generator: (this: void, index: number, env: IParallelTaskEnvironment) => TResult
  ...
  public static create<T>(
    n: number,
    generator: ((this: void, index: number, env: IParallelTaskEnvironment) => T) | IFunctionId | T
  ): ParallelTimesGenerator {
  ...
  public serializeSlice(
    ...
    return functionCallSerializer.serializeFunctionCall(
      FunctionCall.create(ParallelWorkerFunctionIds.TIMES, sliceStart, sliceEnd, iterateeFunction)
    );
  }
}
