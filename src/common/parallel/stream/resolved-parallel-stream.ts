...
export class ResolvedParallelStream<TSub, TOut> implements IParallelStream<TSub, TOut> {
    ...
    public subscribe(onNext: (subResult: TSub, taskIndex: number, valuesPerWorker: number) => void, onError?: (reason: any) => void, onComplete?: (result: TOut) => void): IParallelStream<TSub, TOut> {
