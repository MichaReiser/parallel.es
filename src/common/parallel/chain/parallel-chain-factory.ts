...
export interface IParallelChainFactory {
  /**
   ...
   */
  create<TIn, TEnv extends IParallelEnvironment, TOut>(
    generator: IParallelGenerator,
    options: IDefaultInitializedParallelOptions,
    sharedEnv: TEnv,
    operations?: IParallelOperation[]
...
export const parallelChainFactory: IParallelChainFactory = {
  create<TIn, TEnv extends IParallelEnvironment, TOut>(
    generator: IParallelGenerator,
    options: IDefaultInitializedParallelOptions,
    ...
    const chain = new ParallelChainImpl<TIn, TEnv, TOut>(
