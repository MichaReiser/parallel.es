 ...
 */
export class DependentParallelChainState<TPrevious, TElement>
	implements IParallelChainState<TElement>
{
	/**
	 ...
	 */
	constructor(
		private previousStream: IParallelStream<TPrevious[], TPrevious[]>,
	...
	public resolve(): IScheduledParallelChainState<TElement> {
		...
		return new ScheduledParallelChainState(
			stream,
			this.options,
			this.environment,
		);
	...
	public chainOperation<TElementNew>(
		operation: IParallelOperation,
	): IParallelChainState<TElementNew> {
		return new DependentParallelChainState<TPrevious, TElementNew>(
			this.previousStream,
			this.options,
			this.environment,
	...
	public addEnvironment(
		...
		return new DependentParallelChainState(
			this.previousStream,
			this.options,
