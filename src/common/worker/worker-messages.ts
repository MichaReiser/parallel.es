 ...
 */
export function scheduleTaskMessage(
	task: ITaskDefinition,
): IScheduleTaskMessage {
 ...
 */
export function requestFunctionMessage(
	functionId: IFunctionId,
	...otherFunctionIds: IFunctionId[]
): IFunctionRequest {
	return {
 ...
 */
export function isScheduleTask(
	message: IWorkerMessage,
): message is IScheduleTaskMessage {
...
export function isInitializeMessage(
	message: IWorkerMessage,
): message is IInitializeWorkerMessage {
 ...
 */
export function isFunctionRequest(
	message: IWorkerMessage,
): message is IFunctionRequest {
...
export function isWorkerResult(
	message: IWorkerMessage,
): message is IWorkerResultMessage {
 ...
 */
export function isFunctionExecutionError(
	message: IWorkerMessage,
): message is IFunctionExecutionError {
