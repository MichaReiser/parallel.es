...
describe("FunctionCallDeserializer", function () {
    ...
    describe("deserializeFunctionCall", function () {
        ...
        it("throws if the function is not in the registry", function () {
            ...
            // act, assert
            expect(() => deserializer.deserializeFunctionCall(serializedCall)).toThrowError("The function with the id test-0 could not be retrieved while deserializing the function call. Is the function correctly registered?");
        });
